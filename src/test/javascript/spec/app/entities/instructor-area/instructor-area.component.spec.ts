...
import { InstructorAreaComponent } from 'app/entities/instructor-area/instructor-area.component';
...
describe('Component Tests', () => {
  describe('InstructorArea Management Component', () => {
    let comp: InstructorAreaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InstructorAreaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.instructorAreas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
