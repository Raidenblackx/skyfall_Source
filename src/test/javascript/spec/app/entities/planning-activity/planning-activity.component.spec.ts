...
import { PlanningActivityComponent } from 'app/entities/planning-activity/planning-activity.component';
...
describe('Component Tests', () => {
  describe('PlanningActivity Management Component', () => {
    let comp: PlanningActivityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [PlanningActivityComponent],
        providers: [
          {
        ...
        .overrideTemplate(PlanningActivityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.planningActivities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
