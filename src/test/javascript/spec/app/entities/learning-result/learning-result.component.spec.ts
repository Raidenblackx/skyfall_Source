...
import { LearningResultComponent } from 'app/entities/learning-result/learning-result.component';
...
describe('Component Tests', () => {
  describe('LearningResult Management Component', () => {
    let comp: LearningResultComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LearningResultComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.learningResults[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
