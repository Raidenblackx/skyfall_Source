...
describe('Service Tests', () => {
  describe('LearningResult Service', () => {
    ...
    let elemDefault: ILearningResult;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(LearningResultService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new LearningResult(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a LearningResult', () => {
        ...
        service
          .create(new LearningResult(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
