...
import { CourseStateComponent } from 'app/entities/course-state/course-state.component';
...
describe('Component Tests', () => {
  describe('CourseState Management Component', () => {
    let comp: CourseStateComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [CourseStateComponent],
        providers: [
          {
        ...
        .overrideTemplate(CourseStateComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courseStates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
