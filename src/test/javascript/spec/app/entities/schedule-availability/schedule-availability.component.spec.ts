...
import { ScheduleAvailabilityComponent } from 'app/entities/schedule-availability/schedule-availability.component';
...
describe('Component Tests', () => {
  describe('ScheduleAvailability Management Component', () => {
    let comp: ScheduleAvailabilityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ScheduleAvailabilityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ScheduleAvailability(123)],
            headers
          })
        )
      );
      ...
      expect(comp.scheduleAvailabilities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
