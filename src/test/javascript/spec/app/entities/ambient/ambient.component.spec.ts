...
import { AmbientComponent } from 'app/entities/ambient/ambient.component';
import { AmbientService } from 'app/entities/ambient/ambient.service';
import { Ambient } from 'app/shared/model/ambient.model';

describe('Component Tests', () => {
  describe('Ambient Management Component', () => {
    let comp: AmbientComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AmbientComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.ambients[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
