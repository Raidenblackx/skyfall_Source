...
describe('Service Tests', () => {
  describe('ScheduleVersion Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ScheduleVersionService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new ScheduleVersion(0, 'AAAAAAA', State.ACTIVO);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a ScheduleVersion', () => {
        ...
        service
          .create(new ScheduleVersion(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a ScheduleVersion', () => {
        const returnedFromService = Object.assign(
          {
            numberVersion: 'BBBBBB',
            stateScheduleVersion: 'BBBBBB'
          },
          elemDefault
        );
