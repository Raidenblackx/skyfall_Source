...
import { TimeStudyComponent } from 'app/entities/time-study/time-study.component';
...
describe('Component Tests', () => {
  describe('TimeStudy Management Component', () => {
    let comp: TimeStudyComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TimeStudyComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.timeStudies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
