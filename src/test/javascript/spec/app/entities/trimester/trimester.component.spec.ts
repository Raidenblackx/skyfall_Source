...
import { TrimesterComponent } from 'app/entities/trimester/trimester.component';
...
describe('Component Tests', () => {
  describe('Trimester Management Component', () => {
    let comp: TrimesterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TrimesterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.trimesters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
