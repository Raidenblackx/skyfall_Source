...
describe('Service Tests', () => {
  describe('Trimester Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(TrimesterService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Trimester(0, 0, State.ACTIVO);
    });
