...
import { ModalityComponent } from 'app/entities/modality/modality.component';
...
describe('Component Tests', () => {
  describe('Modality Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.modalities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
