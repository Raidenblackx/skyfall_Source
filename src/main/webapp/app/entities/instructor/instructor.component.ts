...
export class InstructorComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.instructorService
      ...
      .subscribe((res: HttpResponse<IInstructor[]>) => this.paginateInstructors(res.body, res.headers));
  }
  ...
  protected paginateInstructors(data: IInstructor[], headers: HttpHeaders) {
